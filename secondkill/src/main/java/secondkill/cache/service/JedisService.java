...
public class JedisService implements InitializingBean {
    ...
    protected ReentrantLock lockPool = new ReentrantLock();
    protected ReentrantLock lockJedis = new ReentrantLock();

    protected static final Logger logger = Logger.getLogger(JedisService.class);
     ...
     * @param value
     */
    public synchronized void setString(String key, String value, int seconds) {
        try {
            value = StringUtils.isEmpty(value) ? "" : value;
