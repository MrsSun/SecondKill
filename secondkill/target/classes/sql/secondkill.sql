...
CREATE TABLE goods(
  ...
  `surplus` int NOT NULL COMMENT '库存余量',
...
-- 初始化数据
INSERT into goods(name,total, surplus,start_time,end_time)
VALUES
  ('iphone',100, 100,'2016-01-01 00:00:00','2016-01-02 00:00:00'),
  ('小米',200, 200,'2016-01-01 00:00:00','2016-01-02 00:00:00');

-- 记录表
DROP TABLE IF EXISTS record;

CREATE TABLE record(
  `record_id` BIGINT NOT NULL AUTO_INCREMENT COMMENT '秒杀商品ID',
  `user_id` BIGINT NOT NULL COMMENT '用户ID',
  `goods_id` BIGINT NOT NULL COMMENT '物品ID',
  `number` INT NOT NULL COMMENT '下单量',
